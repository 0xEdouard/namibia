...
\vspace{1em}
\textit{Note: Budget figures are estimates. Final costs depend on remaining bookings (Damaraland, Etosha East, Zannier Omaanda).}
...
\textbf{Item} & \textbf{Cost (per person)} \\
\midrule
Accommodation (2 nights, Breeze Lodge) & TBD \\
...
\clearpage
\subsubsection{Accommodation Options: Damaraland (2 nights)}
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \textbf{Cost:} €1,620 for 2 nights (per person)
    ...
    \begin{itemize}
        ...
        \item \textbf{Cost:} €1,400--1,600 for 2 nights (per person)
    ...
    \begin{itemize}
        ...
        \item \textbf{Cost:} €1,200--1,500 for 2 nights (per person)
...
\textbf{Item} & \textbf{Cost (per person)} \\
\midrule
Accommodation (2 nights, Damaraland) & TBD \\
Cape Cross entry & €10 \\
Fuel (420 km) & €60 \\
Optional Twyfelfontein excursion & €0--60 \\
\midrule
\textbf{Total Days 7--8} & \textbf{TBD} \\
\bottomrule
\end{tabular}
...
\subsubsection{Etosha Budget Summary}

\begin{tabular}{@{}lr@{}}
\toprule
\textbf{Item} & \textbf{Cost (per person)} \\
\midrule
Ongava Lodge (1n, Dec 31) & €930 \\
Etosha East (3n, Jan 1--4) & TBD \\
Fuel (250 km drive + park transit) & €70 \\
Park entry fees (3 days) & €25 \\
\midrule
\textbf{Total Etosha} & \textbf{TBD} \\
\bottomrule
\end{tabular}
...
\textbf{Item} & \textbf{Cost (per person)} \\
\midrule
Accommodation (Zannier Omaanda, 2n) & TBD \\
Fuel (430 km) & €60 \\
Souvenirs (optional) & €0--50 \\
\midrule
\textbf{Total Days 14--15} & \textbf{TBD} \\
\bottomrule
\end{tabular}
...
\midrule
\endhead
Sossusvlei & Kulala Desert Lodge & 3 & Dec 24--27 & Private gate, all-inclusive & €1,763 \\
\midrule
Swakopmund & Breeze Lodge & 2 & Dec 27--29 & Swakopmund & TBD \\
\midrule
Damaraland & TBD & 2 & Dec 29--31 & Elephant tracking & TBD \\
\midrule
Etosha West & Ongava Lodge & 1 & Dec 31 -- Jan 1 & Night drives, private waterhole & €930 \\
\midrule
Etosha East & TBD & 3 & Jan 1--4 & Eastern sector & TBD \\
\midrule
Windhoek & Zannier Omaanda & 2 & Jan 4--6 & Luxury lodge, private reserve & TBD \\
\bottomrule
\end{longtable}
\end{landscape}
...
Swakopmund -- Breeze Lodge (2n) & TBD & TBD \\
Damaraland (2n) & TBD & TBD \\
Ongava Lodge (1n) & €930 & €4,650 \\
Etosha East (3n) & TBD & TBD \\
Zannier Omaanda (2n) & TBD & TBD \\
\midrule
\textbf{Subtotal Accommodation} & \textbf{TBD} & \textbf{TBD} \\
\midrule
...
Sossusvlei accommodation (Kulala) & \booked & 947972 \\
Breeze Lodge, Swakopmund & \booked & TBD \\
Damaraland accommodation & \tbdstatus & \\
Etosha West accommodation (Ongava, 1n) & \booked & 18907 \\
Etosha East accommodation (3n) & \booked & TBD \\
\midrule
