...
\begin{itemize}
    ...
    \item \textbf{Dec 27:} Swakopmund \& Skeleton Coast (1 night)
    \item \textbf{Dec 28--31:} Damaraland (3 nights)
...
\clearpage
% -----------------------------------------------------------------------------
\subsection{Day 5: December 27 -- Swakopmund \& Skeleton Coast}
% -----------------------------------------------------------------------------
...
\subsubsection{Accommodation: Swakopmund (1 night)}

\textbf{Breeze Lodge} \hfill \booked

\begin{itemize}
    \item \textbf{Dates:} Dec 27--28, 2025 (1 night)
    \item \textbf{Location:} Swakopmund
\end{itemize}

\subsubsection{Optional Activities in Swakopmund}

\begin{itemize}
    \item \textbf{Sandwich Harbour 4x4 Excursion} (half day) -- dunes meeting the Atlantic, flamingo lagoons, picnic lunch. Contact: Sandwich Harbour 4x4 or Desert Dunes and Dust Tours
    \item Scenic flight over Skeleton Coast \& Sandwich Harbour (1--1.5 hrs)
    \item Quad biking in dunes (1 hour)
    \item Kayaking with seals in Walvis Bay
    \item Township tour
\end{itemize}

\clearpage
% -----------------------------------------------------------------------------
\subsection{Day 6--8: December 28--31 -- Damaraland}
% -----------------------------------------------------------------------------

\subsubsection{Day 6 (Dec 28): Drive to Damaraland via Cape Cross}
...
\subsubsection{Day 7 (Dec 29): Elephant Tracking}
...
\subsubsection{Day 8 (Dec 30): Second Tracking \& Exploration}
...
\subsubsection{Accommodation: Damaraland (3 nights)}

\textbf{Camp Kipwe (2 nights)} \hfill \booked

\begin{itemize}
    \item \textbf{Dates:} Dec 28--30, 2025 (2 nights)
    \item \textbf{Address:} Unnamed Road, Twyfelfontein, 21002, Damaraland, Namibia
    \item \textbf{Phone:} +264 61 232 009
\end{itemize}

\vspace{1em}
\textbf{Mowani Mountain Camp (1 night)} \hfill \booked

\begin{itemize}
    \item \textbf{Booking Reference:} 6072.350.871 (PIN: 7377)
    \item \textbf{Dates:} Dec 30--31, 2025 (1 night)
    \item \textbf{Address:} Unnamed Road, 21002 Khorixas, Damaraland, Namibia
    \item \textbf{Phone:} +264 61 232 009
    \item \textbf{GPS:} S 020° 30.272, E 14° 25.338
    \item 1 Tweepersoonskamer met Patio
    \item \textbf{Included:} Breakfast and dinner
    \item \textbf{Cost:} €394 (NAD 7,735)
\end{itemize}
...
\textbf{EASTERN ETOSHA (3 nights):} \booked

\textbf{Mokuti Etosha Lodge}
\begin{itemize}
    \item \textbf{Booking Reference:} 6586.993.720 (PIN: 7095)
    \item \textbf{Dates:} Jan 1--4, 2026 (3 nights)
    \item \textbf{Address:} Etosha National Park, 9002 Namutoni, Namibia
    \item \textbf{Phone:} +264 67 229 084
    \item \textbf{GPS:} S 018° 48.859, E 17° 3.104
    \item 2 Standard Double Rooms (4 guests)
    \item \textbf{Included:} Breakfast
    \item \textbf{Cost:} €2,172 (NAD 42,638.28)
    \item Near Von Lindequist Gate (eastern Etosha entrance)
...
Breeze Lodge, Swakopmund & +264 64 461 147 \\
Camp Kipwe & +264 61 232 009 \\
Mowani Mountain Camp & +264 61 232 009 \\
Ongava Lodge & reservations@ongava.com \\
Mokuti Etosha Lodge & +264 67 229 084 \\
Zannier Omaanda & +264 61 306 444 \\
\bottomrule
\end{tabular}
...
Breeze Lodge, Swakopmund (Dec 27--28, 1n) & \booked & \\
Camp Kipwe (Dec 28--30, 2n) & \booked & \\
Mowani Mountain Camp (Dec 30--31, 1n) & \booked & 6072.350.871 \\
Ongava Lodge (Dec 31, 1n) & \booked & 18907 \\
Mokuti Etosha Lodge (Jan 1--4, 3n) & \booked & 6586.993.720 \\
