...
Meals (est.) & €200 & €1,000 \\
\midrule
\textbf{Total (excl. flights)} & \textbf{€9,519} & \textbf{€47,593} \\
\textbf{Budget Option (Mushara)} & \textbf{€7,959} & \textbf{€39,793} \\
\bottomrule
\end{tabular}
...
\midrule
\midrule
\textbf{GRAND TOTAL (excl. flights)} & \textbf{€9,459--9,519} & \textbf{€47,293--47,593} \\
\bottomrule
\end{longtable}
...
\begin{itemize}
    ...
    \item \textbf{Current budget (luxury):} €9,459--9,519 per person
    \item \textbf{Status:} \textcolor{warningcolor}{€2,459--2,519 over budget}
    \item \textbf{Solution:} Use Mushara Lodge for Etosha (saves €1,500 pp) to reach €7,959--8,019 per person
